...
namespace SampleApp1
{
    ...
    {   // начало тела класса Calculator
        ...
        public (double, Boolean) GetSingleOperator()   // метод для ввода с клавиатуры операнда
        {   // начало тела метода
            double n1 = 0; // инциализация и определение дефолтного значения
            ...
            try    // блок защиты кода, который может выбросить исключение
            {   // начало тела блока try
                n1 = double.Parse(n);  // попытка преобразовать string -> int
